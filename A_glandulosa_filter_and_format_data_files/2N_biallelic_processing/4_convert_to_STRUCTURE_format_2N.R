...
RAD <- read.table("output_from_step_two_2N_biallelic.txt", 
...
write.table(file = "A_glandulosa_2N_biallelic.str", x = final_formatted,
...
write.table(file = "A_glandulosa_structure_key_table_2N_biallelic.txt", x = df,
